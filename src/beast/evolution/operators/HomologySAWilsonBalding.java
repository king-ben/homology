...
@Description("Implements an SA Wilson Balding, but also changes the value of an input integer parameter that defines the current homology")

public class HomologySAWilsonBalding extends TreeOperator {
    ...
    public double proposal() {
    	...
    	//Changing topology, the code is identical to SA Wilson Balding
